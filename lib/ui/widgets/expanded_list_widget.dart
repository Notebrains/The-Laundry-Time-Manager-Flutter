...
class ExpandedListWidget extends StatelessWidget {
  ...
  const ExpandedListWidget({Key key, this.name, this.image, this.categoryName, this.qty, this.price}) : super(key: key);
            ...
            children: [
              Padding(
                ...
                child: cachedNetImgWithRadius(
                  image, 12 * SizeConfig.widthMultiplier,
                  12 * SizeConfig.widthMultiplier, 3,
                ),
              ),
