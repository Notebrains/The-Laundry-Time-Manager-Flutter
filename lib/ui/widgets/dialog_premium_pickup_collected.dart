...
void showPremiumPickUpCollectedDialog(context, {Function onClose}) async {
                ...
                child: Column (
                  ...
                  children: [
                    Padding(
                      ...
                      child: Txt(txt: 'Premium Pick Up', txtColor: Colors.black87, txtSize: 18, fontWeight: FontWeight.bold, padding: 8, onTap: null),
                    ),

                    StreamBuilder(
                        stream: apiBloc.updatePickupSuccessApi,
