        ...
        child: ListView.builder(
            ...
            itemBuilder: (BuildContext context, int index) {
              if (_searchResult.length != 0 || controller.text.isNotEmpty) {
                return OrdersListWidget(response: _searchResult, index: index,
                    onTapOnList: null, onTapOnBtn: null, onTapOnItems: null,
                  onRefreshed: (){
                ...
                listData = response;
                return OrdersListWidget(response: listData, index: index, onTapOnList: (index){
                  Navigator.push(
                    context,
                    MaterialPageRoute(
